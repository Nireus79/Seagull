...
BuyFeatures = ['TrD3', '4H%K', 'bb_cross']  # ['4H%DS', 'TrD3', 'bb_cross']
...
if 'bb_cross' in X_trainBuy.columns:
    print('bb_cross in X')
    X_trainBuy_n.drop(columns=['bb_cross'], axis=1, inplace=True)
    X_testBuy_n.drop(columns=['bb_cross'], axis=1, inplace=True)
...
if 'bb_cross' in X_trainSell.columns:
    print('bb_cross in X')
    X_trainSell_n.drop(columns=['bb_cross'], axis=1, inplace=True)
    X_testSell_n.drop(columns=['bb_cross'], axis=1, inplace=True)
